...
export default function Card() {
  return (
    <div className="w-[900px] mx-auto overflow-hidden rounded-[8px]  relative z-10 bg-white/10 backdrop-blur-md p-6 relative  shadow-2xl">
      ...
      <div className="flex w-full mt-4  p-6 items-center gap-4">
        <div className=" ring-1 ring-white/20 w-[99px] h-[99px] rounded-full overflow-hidden flex-shrink-0">
          <Image src="/eu.png" alt="eu" width={100} height={100} />
        </div>
        <div className="flex flex-col gap-1">
          <h3 className="text-white/90 font-bold font-orbitron">
            Olá! Me chamo Heitor
          </h3>
          <p className="text-white/90 text-sm max-w-[600px] leading-relaxed font-orbitron ">
            sou um desenvolvedor apaixonado e especializado em front-end Busco
            constantemente criar interfaces elegantes, responsivas e com
      ...
      <div className="flex w-full  px-6">
        <h2 className="font-orbitron text-white/90 text-2xl italic font-bold">
          Principais Projetos :
        </h2>
      </div>
