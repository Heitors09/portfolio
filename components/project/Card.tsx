...
export default function Card() {
  return (
    <div className="w-full max-w-[800px] ring-1 ring-[#E3DAE3] h-screen max-sm:overflow-y-auto sm:h-auto mx-auto overflow-hidden rounded-[8px] relative z-10 bg-white/50 backdrop-blur-md p-1 sm:pt-6 shadow-2xl">
      <div className="w-full h-12 bg-white absolute border-b border-[#E3DAE3] top-0 left-0 flex items-center px-4">
        <div className="flex gap-2">
          <div className="w-3 h-3 rounded-full bg-[#6D94F3]"></div>
          <div className="w-3 h-3 rounded-full bg-[#6D94F3]"></div>
          <div className="w-3 h-3 rounded-full bg-[#6D94F3]"></div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row w-full mt-4 p-3 sm:p-6 items-start gap-4">
        ...
        <div className="flex flex-col gap-1 text-center sm:text-left">
          <h3 className="font-semibold text-[#252226] font-orbitron text-lg sm:text-xl">
            Olá! Me chamo Heitor
          </h3>
          <p className="text-sm text-[#756E78] sm:text-sm max-w-[600px] leading-relaxed font-orbitron">
          ...
          <div className="flex justify-center sm:justify-start gap-4 mt-2">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="sm:w-6 sm:h-6 text-[#6D94F3]"
              >
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="bg-zinc-900 px-4 py-3 rounded-lg border border-zinc-800 shadow-xl">
                  <p className="font-medium">heitorao32@gmail.com</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="bg-zinc-900 px-4 py-3 rounded-lg border border-zinc-800 shadow-xl">
                  <p className="font-medium">kefka_palazzo06</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
